...
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('التصنيع', 'Manufacturing', 'نقدم حلولاً مالية وضريبية متكاملة لقطاع التصنيع لدعم الكفاءة التشغيلية، وتقليل تكاليف الإنتاج.', 'We provide integrated financial and tax solutions to support operational efficiency and reduce production costs.', '/images/sectors/manufacturing.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('التجارة', 'Trade & Retail', 'دعم مالي واستراتيجي لقطاع التجارة لمواجهة تحديات سلسلة التوريد وتعزيز ربحية المبيعات.', 'Strategic support for the trade sector to navigate supply chain challenges and enhance sales profitability.', '/images/sectors/trade_retail.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('الاغذية والمشروبات', 'Food & Beverage', 'استشارات متخصصة لضمان كفاءة سلاسل الإمداد، التوافق الضريبي، وإدارة التكاليف المتغيرة بكفاءة عالية.', 'Specialized advisory to ensure supply chain efficiency, tax compliance, and variable cost management.', '/images/sectors/food_beverage.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('مقاولات عامة', 'General Contracting', 'خدمات شاملة تشمل إدارة الحسابات المرحلية، تخطيط السيولة المالية، وتخفيف المخاطر التعاقدية للمقاولين.', 'Comprehensive services including interim account management, liquidity planning, and contractual risk mitigation.', '/images/sectors/general_contracting.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('عقارات والتشييد', 'Real Estate & Construction', 'توجيه استراتيجي لمطوري العقارات لتعظيم العائد على الاستثمار، وإدارة التدفقات النقدية للمشاريع الطويلة.', 'Strategic guidance to maximize ROI and manage cash flows for long-term real estate development projects.', '/images/sectors/real_estate.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('التعدين والبترول', 'Mining & Petroleum', 'خبرة واسعة في الاستشارات الضريبية والمحاسبية لقطاع التعدين، مع التركيز على الامتثال التنظيمي للموارد.', 'Extensive expertise in tax and accounting advisory, focusing on regulatory compliance and sustainability.', '/images/sectors/mining_petroleum.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('التكنولوجيا والاتصالات', 'Technology & Telecommunications', 'حلول مبتكرة لدعم النمو السريع، هيكلة الاستثمارات التقنية، والامتثال لمعايير التقارير المالية الدولية.', 'Innovative solutions to support rapid growth, investment structuring, and IFRS compliance for tech firms.', '/images/sectors/technology_telecom.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('الصناعات الدوائية', 'Pharmaceutical Industries', 'دعم مالي دقيق يلبي متطلبات الرقابة الصارمة، ويُحسن ميزانيات البحث والتطوير للصناعات الدوائية.', 'Precise financial support meeting strict regulatory demands and optimizing R&D budgets for pharma.', '/images/sectors/pharmaceutical.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('الفنادق', 'Hotels & Hospitality', 'استراتيجيات مالية مخصصة لقطاع الضيافة تهدف إلى تحسين هوامش الربح وإدارة التكاليف التشغيلية الموسمية.', 'Financial strategies tailored for hospitality aimed at improving profit margins and managing seasonal costs.', '/images/sectors/hospitality.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('المؤسسات التعليمية', 'Educational Institutions', 'خدمات تركز على الإدارة المالية المستدامة، التخطيط طويل الأجل، وتطوير البنية التحتية التعليمية.', 'Services focused on sustainable financial management, long-term planning, and infrastructure development.', '/images/sectors/education.jpg', '', '');
INSERT INTO sectors (title, title_en, description, description_en, image, content, content_en) VALUES ('المنظمات غير الهادفة للربح', 'Non-Profit Organizations', 'ضمان أعلى مستويات الشفافية والحوكمة من خلال تقارير مالية دقيقة وإدارة رشيدة للمنح والتمويل الخيري.', 'Ensuring high transparency and governance through accurate financial reporting and prudent grant management.', '/images/sectors/non_profit.jpg', '', '');
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('الاستشارات المحاسبية وإعداد التقارير المالية', 'Accounting Advisory & Financial Reporting', 'نقدم حلولاً محاسبية تساعد المؤسسات على بناء منظومة مالية قوية وتعزيز الشفافية.', 'We provide accounting solutions that help organizations build a strong financial framework and enhance transparency.', '/images/services/accounting.jpg', 'في بيئة أعمال تتسم بالتغير المستمر، والتطور المتسارع في المعايير المحاسبية، وزيادة المتطلبات التنظيمية، أصبحت القرارات المالية أكثر تعقيدًا من أي وقت مضى. ولم يعد نجاح المؤسسات يعتمد فقط على إعداد قوائم مالية دقيقة، بل على قدرتها على تفسير المعلومات المالية، وإدارة المخاطر، وتحقيق الامتثال، ودعم القرارات الاستراتيجية التي تحقق النمو المستدام.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('المراجعة وابداء الرأي المهني', 'Review and Expression of Professional Opinion', 'أدوات استراتيجية لبناء الثقة، وتعزيز الحوكمة، وإدارة المخاطر، ودعم النمو المستدام.', 'Strategic instruments for building trust, strengthening governance, and enabling sustainable growth.', '/images/services/audit.jpg', 'في **AFC – Ashmawy Financial Consulting** نؤمن بأن المراجعة والاستشارات ليست مجرد خدمات مهنية، بل أدوات استراتيجية لبناء الثقة، وتعزيز الحوكمة، وإدارة المخاطر، ودعم النمو المستدام.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('الاستشارات الضريبية والامتثال الضريبي', 'Tax Advisory & Compliance', 'نساعد الشركات على التعامل بثقة مع البيئة الضريبية وضمان الامتثال الكامل للتشريعات.', 'Helping organizations confidently navigate the complex tax environment while ensuring full compliance.', '/images/services/tax_advisory.jpg', 'في **AFC – AL-Ashmawy Financial Consulting** نؤمن بأن الضرائب ليست مجرد التزام قانوني، بل عنصر استراتيجي يؤثر بصورة مباشرة في كفاءة الأعمال، والأداء المالي، واستدامة النمو.
...
في **AFC** لا نساعد عملاءنا على الامتثال للقوانين الضريبية فحسب، بل نوفر حلولًا ضريبية استراتيجية تعزز الأداء المالي، وتخفض المخاطر، وتحمي الأعمال، وتدعم تحقيق نمو مستدام في بيئة تشريعية دائمة التطور.', 'At **AFC – Ashmawy Financial Consulting**, we believe that taxation is more than a statutory obligation—it is a strategic function that directly influences business performance, financial efficiency, and long-term sustainability.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('تأسيس الشركات والمنشأت', 'Company Formation & Corporate Services', 'نساعد عملاءنا على اختيار الهيكل القانوني الأنسب وفقًا لطبيعة النشاط والمتطلبات التنظيمية.', 'Helping entrepreneurs and investors establish businesses that are legally sound and strategically positioned.', '/images/services/company.jpg', 'يمثل اختيار الشكل القانوني المناسب للمنشأة أحد أهم القرارات الاستراتيجية التي تؤثر على مستقبل الأعمال، والالتزامات القانونية، والهيكل الضريبي، وآليات الإدارة، وفرص النمو والاستثمار.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('الإجراءات الضريبية', 'Tax Procedures', 'نقدم الإجراءات الضريبية الكاملة من تأسيس النشاط وحتى الفحص الضريبي وسداد المستحقات.', 'Complete tax procedures from business establishment to tax audits and payments.', '/images/services/tax_procedures.jpg', 'تُعد الإجراءات الضريبية مجموعة من الخطوات القانونية والإدارية التي يلتزم بها الممول منذ تأسيس النشاط وحتى تقديم الإقرارات وسداد الضرائب المستحقة، وذلك وفقًا لأحكام القوانين واللوائح الضريبية المعمول بها في جمهورية مصر العربية. وتهدف هذه الإجراءات إلى ضمان الامتثال الضريبي، وتعزيز الشفافية، وتنظيم العلاقة بين الممول ومصلحة الضرائب.
...
- **السابع عشر:** تحديث بيانات الممول والالتزام الدائم بكافة التعديلات الضريبية.', 'Tax procedures are a set of legal and administrative steps that taxpayers must follow from the establishment of a business until filing tax returns and paying the taxes due, in accordance with the applicable tax laws and regulations in the Arab Republic of Egypt. These procedures aim to ensure tax compliance, promote transparency, and regulate the relationship between taxpayers and the Egyptian Tax Authority.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('الفحص الضريبي', 'Tax Examination & Audit Support', 'نساعد عملاءنا على تقليل المخاطر الضريبية، وتمثيلهم باحترافية أمام مصلحة الضرائب المصرية.', 'Helping clients identify potential tax exposures and representing them throughout the examination process.', '/images/services/tax_examination.jpg', 'تُعد الفحوصات الضريبية من أكثر المراحل حساسية في دورة حياة أي منشأة، حيث قد يترتب عليها فروق ضريبية، وغرامات، وجزاءات، ومنازعات تؤثر على المركز المالي وسمعة المنشأة واستمرارية أعمالها.
...
في AFC نعتبر كل فحص ضريبي فرصة لإثبات قوة منظومة الامتثال لدى عملائنا، وحماية أعمالهم، وتعزيز ثقة المستثمرين والإدارة في سلامة مراكزهم الضريبية.', 'Tax examinations represent one of the most critical stages in the lifecycle of any business. If not properly managed, they may result in additional tax assessments, financial penalties, interest, prolonged disputes, and significant operational and reputational risks. In today''s evolving regulatory environment, successful organizations recognize that effective tax management begins long before an examination takes place.
...
INSERT INTO services (title, title_en, description, description_en, image, content, content_en) VALUES ('التراخيص الصناعية', 'Industrial Licensing', 'خدمات استشارية وتنفيذية متكاملة للحصول على التراخيص الصناعية.', 'Comprehensive advisory and execution services for obtaining industrial licenses.', '/images/services/industrial.jpg', 'نقدم خدمات استشارية وتنفيذية متكاملة للحصول على التراخيص الصناعية، مع دعم عملائنا في جميع مراحل إصدار الترخيص. وتشمل خدماتنا دراسة متطلبات الترخيص، وإعداد ومراجعة المستندات القانونية والفنية، والتنسيق مع الجهات الحكومية المختصة، ومتابعة الطلبات حتى صدور الموافقات النهائية. كما نقدم الاستشارات المتعلقة بالاشتراطات الصناعية والبيئية ومتطلبات السلامة، بما يضمن الامتثال الكامل للتشريعات المنظمة، وتقليل المخاطر، وتسريع إجراءات بدء أو التوسع في النشاط الصناعي.
...
INSERT INTO features (title, title_en, description, description_en, icon) VALUES ('الخبرة الواسعة', 'Extensive Experience', 'فريق من الخبراء المتخصصين في مختلف المجالات المالية والضريبية', 'A team of specialized experts in various financial and tax fields.', 'BadgeCheck');
INSERT INTO features (title, title_en, description, description_en, icon) VALUES ('الدقة والموثوقية', 'Accuracy & Reliability', 'نلتزم بأعلى معايير الجودة والدقة في جميع خدماتنا', 'We adhere to the highest standards of quality and precision in all our services.', 'Target');
INSERT INTO features (title, title_en, description, description_en, icon) VALUES ('حلول متكاملة', 'Comprehensive Solutions', 'نقدم باقة شاملة من الخدمات التي تلبي كافة احتياجات عملائنا', 'We provide a comprehensive suite of services that meet all our clients'' needs.', 'Layers');
INSERT INTO features (title, title_en, description, description_en, icon) VALUES ('الالتزام بالوقت', 'Punctuality', 'نقدر وقت عملائنا ونلتزم بتقديم خدماتنا في الوقت المحدد', 'We value our clients'' time and are committed to delivering our services on schedule.', 'Clock');
INSERT INTO stats (title, title_en, value, value_en) VALUES ('سنوات الخبرة', 'Years of Experience', '+15', '+15');
INSERT INTO stats (title, title_en, value, value_en) VALUES ('عميل سعيد', 'Happy Clients', '+500', '+500');
INSERT INTO stats (title, title_en, value, value_en) VALUES ('مشروع ناجح', 'Successful Projects', '+1000', '+1000');
INSERT INTO stats (title, title_en, value, value_en) VALUES ('خبير مالي', 'Financial Experts', '+50', '+50');
INSERT INTO testimonials (name, name_en, position, position_en, content, content_en, rating) VALUES ('أحمد محمود', 'Ahmed Mahmoud', 'المدير التنفيذي لشركة الأفق', 'CEO of Al-Ofouq', 'خدمات احترافية وفريق عمل متميز، ساعدونا كثيراً في تحسين الكفاءة المالية لشركتنا.', 'Professional services and an outstanding team, they helped us significantly improve our company''s financial efficiency.', 5);
INSERT INTO testimonials (name, name_en, position, position_en, content, content_en, rating) VALUES ('محمد علي', 'Mohamed Ali', 'رئيس مجلس إدارة مجموعة النور', 'Chairman of Al-Nour Group', 'استشاراتهم الضريبية وفرت علينا الكثير من الوقت والجهد، شكراً لكم.', 'Their tax advisory saved us a lot of time and effort, thank you.', 5);
INSERT INTO testimonials (name, name_en, position, position_en, content, content_en, rating) VALUES ('سارة حسن', 'Sara Hassan', 'مديرة الحسابات في شركة القمة', 'Accounting Manager at Al-Qimma', 'دقة في المواعيد واحترافية في التعامل، نعتمد عليهم في كافة أعمالنا المالية.', 'Punctual and professional, we rely on them for all our financial operations.', 5);
