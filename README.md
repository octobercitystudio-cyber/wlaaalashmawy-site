...
هاتان القيمتان ضروريتان للتثبيت الجديد وإعادة تعيين دخول الإدارة. تبقى كلمة المرور الخام داخل GitHub Secrets فقط، ويحوّلها مسار النشر إلى بصمة PHP غير قابلة للاسترجاع قبل رفع ملف الإعداد. لا يقبل النظام كلمات المرور المخزنة كنص صريح، ولا تستخدم FTP غير المشفر، ولا تضف `config.php` الناتج أو مجلد الرفع إلى المستودع.
