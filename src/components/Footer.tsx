      ...
      <div className="container grid grid-cols-1 md-grid-cols-3 gap-lg">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-sm" style={{ opacity: 0.9 }}>
            <li>📧 {email}</li>
            <li dir="ltr" style={{ textAlign: "right" }}>📞 {phone}</li>
            <li>📍 {address}</li>
          </ul>
          
          <div style={{ display: "flex", gap: "1rem", marginTop: "1.5rem" }}>
            {settings.social_facebook && (
            <a href={settings.social_facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-100" style={{ width: "36px", height: "36px", borderRadius: "10px", background: "#1877F2", color: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.3s ease", opacity: 0.9 }}>
            ...
            <a href={settings.social_linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-100" style={{ width: "36px", height: "36px", borderRadius: "10px", background: "#0A66C2", color: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.3s ease", opacity: 0.9 }}>
