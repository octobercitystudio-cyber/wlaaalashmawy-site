...
نوفر خدمات مراجعة مستقلة تمنح الإدارة والمساهمين والمستثمرين والجهات الرقابية الثقة في موثوقية المعلومات المالية، وسلامة نظم الرقابة الداخلية، والالتزام بالمعايير والتشريعات.
ولا تقتصر أعمالنا على إبداء الرأي المهني في القوائم المالية، بل تمتد إلى تقديم توصيات عملية لتحسين الأداء المالي، وتعزيز الحوكمة، وإدارة المخاطر، ورفع كفاءة العمليات التشغيلية.

**ثانيًا: الخدمات الاستشارية**
نساعد عملاءنا على تحويل التحديات إلى فرص للنمو من خلال تقديم استشارات مالية واستراتيجية مبنية على التحليل والخبرة.
وتشمل خدماتنا تطوير الأنظمة المالية، وتحسين الرقابة الداخلية، وإعادة هيكلة الأعمال، ودراسات الجدوى، والتخطيط الضريبي، والتحول إلى المعايير الدولية، وإدارة المخاطر، والاستشارات المالية، بما يساعد المؤسسات على تحقيق أداء مستدام واتخاذ قرارات أكثر فاعلية في بيئة أعمال متغيرة.
...
Our independent audit and assurance services provide management, shareholders, investors, financial institutions, and regulators with confidence in the reliability of financial information, the effectiveness of internal controls, and compliance with applicable professional standards and regulatory requirements.
Beyond expressing an independent audit opinion, we provide valuable insights and practical recommendations that improve financial reporting, reinforce corporate governance, strengthen internal control environments, and support informed strategic decision-making.

**Advisory Services**
Our advisory practice helps organizations transform challenges into opportunities through strategic financial and business consulting.
...
At AFC, we do not simply provide professional services—we build enduring partnerships founded on integrity, technical excellence, independence, and an unwavering commitment to helping our clients achieve lasting success.`
  ...
  },
  {
    ...
    shortDesc: {
      ar: "نساعد الشركات على التعامل بثقة مع البيئة الضريبية وضمان الامتثال الكامل للتشريعات.",
...
تعتمد خدماتنا على أفضل الممارسات المهنية والمعايير الدولية، بما في ذلك المعايير الدولية لإعداد التقارير المالية (IFRS)، ومعايير المحاسبة الدولية (IAS)، ومعايير المحاسبة المصرية (EAS)، إضافة إلى المتطلبات التشريعية والتنظيمية ذات الصلة، بما يضمن إعداد تقارير مالية تتسم بالدقة والشفافية وقابلية الاعتماد.
...
- تقديم الاستشارات الفنية المتعلقة بتطبيق معايير IFRS وIAS وEAS.
...
At AFC, we believe that accounting is far more than recording transactions—it is the language of business, the foundation of trust, and a critical driver of strategic decision-making and long-term success.`
  ...
  },
  {
    ...
    shortDesc: {
      ar: "نساعد عملاءنا على تقليل المخاطر الضريبية، وتمثيلهم باحترافية أمام مصلحة الضرائب المصرية.",
...
Payroll tax examinations focus on verifying the correct calculation, withholding, reporting, and remittance of payroll taxes relating to salaries, wages, bonuses, and employee benefits.
Our specialists review payroll records, employment contracts, annual payroll reconciliations, employee benefit schemes, and tax calculations to ensure full compliance with the relevant provisions of the Egyptian Income Tax Law while reducing the risk of additional assessments and penalties.

**Withholding Tax Examination**
This examination evaluates whether withholding tax obligations have been correctly applied to payments made to suppliers, contractors, and service providers.
We review withholding tax calculations, tax forms, payment records, statutory filing requirements, and supporting documentation to ensure compliance with the applicable provisions of the Egyptian tax legislation and minimize potential financial exposure.

**Stamp Tax Examination**
Stamp tax examinations involve reviewing contracts, agreements, financial transactions, and taxable instruments to ensure the proper calculation and payment of stamp tax in accordance with Stamp Tax Law No. 111 of 1980 and its amendments.
Our team evaluates potential liabilities, identifies compliance gaps, and provides practical recommendations to mitigate future tax risks.

**Value Added Tax (VAT) Examination**
VAT examinations include a comprehensive review of VAT returns, tax invoices, input tax deductions, output tax calculations, refund claims, and compliance with electronic invoicing and electronic receipt requirements.
We assist clients in ensuring compliance with the Value Added Tax Law No. 67 of 2016, reducing VAT risks, resolving technical issues, and supporting them throughout the examination process before the Egyptian Tax Authority.
...
We build the legal, financial, and governance foundation upon which successful businesses grow. By combining legal awareness, financial expertise, and regulatory knowledge, we help our clients establish compliant, resilient, and investment-ready organizations while minimizing risk, reducing administrative complexity, and supporting sustainable business growth from day one.`
  ...
  },
  {
    ...
    shortDesc: {
      ar: "خدمات استشارية وتنفيذية متكاملة للحصول على التراخيص الصناعية.",
...
- ملف بيئي وفني`,
  ...
  },
  {
    ...
    content: {
      ar: `نقدم خدمات متكاملة لاستخراج وتجديد وإدارة إقامات المستثمرين في جمهورية مصر العربية، مع توفير الدعم الكامل في جميع مراحل الإجراءات وحتى إصدار الإقامة. وتشمل خدماتنا مراجعة شروط الاستحقاق، وإعداد ومراجعة المستندات المطلوبة، وتقديم الطلبات، والتنسيق مع الجهات الحكومية المختصة، ومتابعة الإجراءات حتى الانتهاء منها. كما نقدم الدعم المستمر فيما يتعلق بتجديد الإقامات والالتزام بالمتطلبات التنظيمية، بما يضمن للمستثمرين استقرار أوضاعهم القانونية ويتيح لهم التركيز على تأسيس أعمالهم وتطوير استثماراتهم بثقة ووفقًا للقوانين المصرية.

### وتشمل:
- الاستعلام الامني
- منح اقامة مستثمر`,
      en: `We provide end-to-end support for obtaining, renewing, and managing investor residency permits in Egypt, ensuring a smooth and efficient process from application to issuance. Our professionals assist clients in determining eligibility, preparing and reviewing all required documentation, submitting applications, coordinating with the relevant governmental authorities, and monitoring every stage of the process. We also provide ongoing guidance on residency renewals and regulatory compliance, enabling investors to establish and expand their businesses with confidence while ensuring full adherence to Egyptian investment and immigration regulations.`
    }
  }
];
