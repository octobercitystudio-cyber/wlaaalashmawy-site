      ...
      <section className="py-xl" style={{ backgroundColor: "var(--color-bg-body)" }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 md-grid-cols-3 gap-lg mb-xl">
            <div className="animate-fade-in-up" style={{ animationDelay: "0.1s", background: "var(--color-bg-card)", border: "1px solid var(--color-border)", padding: "1.5rem 1rem", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "0.5rem", borderRadius: "12px" }}>
              <div style={{ width: "50px", height: "50px", borderRadius: "50%", background: "rgba(0, 91, 171, 0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
              </div>
              <div>
                <h3 style={{ fontSize: "1.2rem", color: "var(--color-accent)", marginBottom: "0.5rem" }}>اتصل بنا</h3>
                <p dir="ltr" style={{ color: "var(--color-text-main)", fontSize: "1.1rem", fontWeight: "bold", marginBottom: "0.2rem" }}>01155729429</p>
                <p dir="ltr" style={{ color: "var(--color-text-main)", fontSize: "1.1rem", fontWeight: "bold" }}>0238345397</p>
              </div>
            </div>

            <div className="animate-fade-in-up" style={{ animationDelay: "0.2s", background: "var(--color-bg-card)", border: "1px solid var(--color-border)", padding: "1.5rem 1rem", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "0.5rem", borderRadius: "12px" }}>
              <div style={{ width: "50px", height: "50px", borderRadius: "50%", background: "rgba(0, 91, 171, 0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
              </div>
              <div>
                <h3 style={{ fontSize: "1.2rem", color: "var(--color-accent)", marginBottom: "0.5rem" }}>البريد الإلكتروني</h3>
                <p style={{ color: "var(--color-text-main)", fontSize: "1.1rem", fontWeight: "bold", marginBottom: "0.2rem" }}>info@alashmawy.com</p>
                <p style={{ color: "var(--color-text-main)", fontSize: "1.1rem", fontWeight: "bold" }}>support@alashmawy.com</p>
              </div>
            </div>

            <div className="animate-fade-in-up" style={{ animationDelay: "0.3s", background: "var(--color-bg-card)", border: "1px solid var(--color-border)", padding: "1.5rem 1rem", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "0.5rem", borderRadius: "12px" }}>
              <div style={{ width: "50px", height: "50px", borderRadius: "50%", background: "rgba(0, 91, 171, 0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
              </div>
              <div>
                <h3 style={{ fontSize: "1.2rem", color: "var(--color-accent)", marginBottom: "0.5rem" }}>المقر الرئيسي</h3>
          ...
          <div className="grid grid-cols-1 md-grid-cols-2 gap-lg items-stretch">
            ...
            {/* Left: Map */}
            <div className="animate-fade-in-up" style={{ animationDelay: "0.5s", padding: "1rem", background: "var(--color-bg-card)", border: "1px solid var(--color-border)", borderRadius: "12px", height: "100%", minHeight: "450px" }}>
              <iframe 
