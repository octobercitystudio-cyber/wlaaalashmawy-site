...
After obtaining the operating license, an application is submitted to issue the Industrial Registration Certificate, ensuring the project is officially registered and fully compliant.`}}];e.s(["servicesData",0,i])},68835,e=>{"use strict";var i=e.i(43476),n=e.i(71645),t=e.i(57688),a=e.i(32642);e.s(["default",0,function({initialArticles:e,lang:r="ar",initialArticleId:o}){let[s,l]=(0,n.useState)(e),[c,d]=(0,n.useState)(!1),[p,u]=(0,n.useState)(""),[g,m]=(0,n.useState)([]),[h,f]=(0,n.useState)([]);(0,n.useEffect)(()=>{fetch("/api/articles.php").then(e=>e.json()).then(e=>{Array.isArray(e)&&(l(e),e.length>0&&!e.find(e=>e.id===A)&&C(o||e[0].id))}).catch(e=>console.error("Failed to fetch fresh articles",e)),fetch("/api/settings.php").then(e=>e.json()).then(e=>{if(e.article_categories)try{let i=JSON.parse(e.article_categories);Array.isArray(i)&&m(i)}catch(e){}}).catch(()=>{}),fetch("/api/services.php").then(e=>e.json()).then(e=>{Array.isArray(e)&&f(e)}).catch(()=>{})},[]);let y=Array.isArray(s)?s:[],v=n.default.useMemo(()=>{let e=new Map;return[{ar:"الاستشارات المحاسبية",en:"Accounting Advisory"},{ar:"الاستشارات الضريبية",en:"Tax Advisory"},{ar:"المراجعة والتدقيق",en:"Audit & Assurance"},{ar:"تأسيس الشركات",en:"Company Formation"},{ar:"الاستشارات المالية",en:"Financial Advisory"}].forEach(i=>e.set(i.ar.trim(),i)),a.servicesData.forEach(i=>{i&&i.title&&i.title.ar&&!e.has(i.title.ar.trim())&&e.set(i.title.ar.trim(),{ar:i.title.ar.trim(),en:(i.title.en||i.title.ar).trim()})}),h.forEach(i=>{i&&i.title&&"string"==typeof i.title&&!e.has(i.title.trim())&&e.set(i.title.trim(),{ar:i.title.trim(),en:(i.title_en||i.title).trim()})}),g.forEach(i=>{i&&i.ar&&e.set(i.ar.trim(),{ar:i.ar.trim(),en:(i.en||i.ar).trim()})}),y.forEach(i=>{i.category&&i.category.trim()&&!e.has(i.category.trim())&&e.set(i.category.trim(),{ar:i.category.trim(),en:(i.category_en||i.category).trim()})}),Array.from(e.values())},[g,y,h]),x=e=>{if(!e)return null;let i="";return e.includes("youtu.be/")?i=e.split("youtu.be/")[1].split("?")[0].split("&")[0]:e.includes("watch?v=")?i=e.split("watch?v=")[1].split("&")[0]:e.includes("embed/")?i=e.split("embed/")[1].split("?")[0].split("&")[0]:e.includes("shorts/")&&(i=e.split("shorts/")[1].split("?")[0].split("&")[0]),i?`https://www.youtube.com/embed/${i}`:null},[b,w]=(0,n.useState)("الكل"),[A,C]=(0,n.useState)(o||(e&&e.length>0?e[0].id:0)),[T,S]=(0,n.useState)(""),F=y.filter(e=>{let i="الكل"===b||e.category===b,n=e?.title?.includes(T);return i&&n}),j=y.find(e=>e.id===A),k=e=>{w(e);let i=y.filter(i=>{let n="الكل"===e||i.category===e,t=i?.title?.includes(T);return n&&t});i.length>0?i.find(e=>e.id===A)||C(i[0].id):C(0)};return(0,i.jsxs)("div",{className:"animate-fade-in",style:{flex:1,padding:"var(--spacing-xl) 0"},children:[(0,i.jsx)("style",{dangerouslySetInnerHTML:{__html:`
        .articles-layout {
          display: flex;
      ...
      `}}),(0,i.jsxs)("div",{className:"container",children:[(0,i.jsxs)("div",{className:"text-center mb-xl",children:[(0,i.jsx)("h1",{className:"text-gold",style:{fontSize:"3rem",marginBottom:"var(--spacing-md)"},children:"en"===r?"Blog & Articles":"المقالات والمدونة"}),(0,i.jsx)("p",{style:{fontSize:"1.2rem",maxWidth:"800px",margin:"0 auto",color:"var(--color-text-main)",opacity:.9,fontWeight:"700"},children:"en"===r?"Stay up to date with the latest developments in accounting, tax, and business. We offer professional insights and valuable tips to support your success.":"ابقَ على اطلاع دائم بأحدث التطورات في عالم المحاسبة، الضرائب، والأعمال. نقدم لك تحليلات احترافية ونصائح قيمة لدعم مسيرة نجاحك."})]}),(0,i.jsxs)("div",{className:"articles-layout",children:[(0,i.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[(0,i.jsx)("h3",{style:{fontSize:"1.5rem",color:"var(--color-primary)"},children:"en"===r?"Latest Articles":"أحدث المقالات"}),(0,i.jsxs)("div",{style:{position:"relative",marginBottom:"1rem"},children:[(0,i.jsx)("input",{type:"text",placeholder:"en"===r?"Search articles...":"ابحث باسم المقال...",value:T,onChange:e=>{let i=e.target.value;S(i);let n=y.filter(e=>{let n="الكل"===b||e.category===b,t=e?.title?.includes(i);return n&&t});n.length>0?n.find(e=>e.id===A)||C(n[0].id):C(0)},style:{width:"100%",padding:"0.8rem 1rem",paddingRight:"2.5rem",borderRadius:"8px",border:"1px solid var(--color-border)",outline:"none",fontSize:"1rem"}}),(0,i.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"var(--color-text-muted)",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",style:{position:"absolute",right:"0.8rem",top:"50%",transform:"translateY(-50%)"},children:[(0,i.jsx)("circle",{cx:"11",cy:"11",r:"8"}),(0,i.jsx)("line",{x1:"21",y1:"21",x2:"16.65",y2:"16.65"})]})]}),c?(0,i.jsx)("p",{style:{color:"var(--color-text-muted)"},children:"en"===r?"Loading articles...":"جاري تحميل المقالات..."}):p?(0,i.jsx)("p",{style:{color:"red"},children:p}):F.length>0?F.map(e=>(0,i.jsxs)("button",{onClick:()=>C(e.id),style:{display:"block",width:"100%",textAlign:"right",padding:"1.2rem",background:A===e.id?"rgba(0, 91, 171, 0.05)":"var(--color-bg-card)",border:"1px solid",borderColor:A===e.id?"var(--color-accent)":"var(--color-border)",borderRadius:"8px",cursor:"pointer",transition:"all 0.3s ease",borderRight:A===e.id?"4px solid var(--color-accent)":"1px solid var(--color-border)"},children:[(0,i.jsx)("h4",{style:{fontSize:"1.1rem",color:A===e.id?"var(--color-accent)":"var(--color-primary)",marginBottom:"0.5rem",lineHeight:"1.4"},children:"en"===r&&e.title_en?e.title_en:e.title}),(0,i.jsx)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:(0,i.jsx)("span",{style:{fontSize:"0.85rem",color:"var(--color-text-muted)"},children:e.date})}),(0,i.jsx)("a",{href:"en"===r?`/en/articles/${e.id}`:`/articles/${e.id}`,style:{display:"none"},"aria-hidden":"true",children:e.title})]},e.id)):(0,i.jsx)("p",{style:{color:"var(--color-text-muted)"},children:"en"===r?"No matching articles found.":"لا توجد مقالات مطابقة للبحث."})]}),(0,i.jsxs)("div",{style:{minHeight:"500px",padding:"0 1rem"},children:[(0,i.jsxs)("div",{className:"flex gap-sm mb-lg",style:{flexWrap:"wrap",borderBottom:"1px solid var(--color-border)",paddingBottom:"1.5rem"},children:[(0,i.jsx)("button",{onClick:()=>k("الكل"),style:{padding:"0.5rem 1.5rem",borderRadius:"30px",background:"الكل"===b?"var(--color-accent)":"transparent",color:"الكل"===b?"#fff":"var(--color-text-main)",fontWeight:"الكل"===b?"bold":"normal",transition:"all 0.3s ease",border:"الكل"===b?"1px solid var(--color-accent)":"1px solid var(--color-border)"},children:"en"===r?"All":"الكل"}),v.map(e=>(0,i.jsx)("button",{onClick:()=>k(e.ar),style:{padding:"0.5rem 1.5rem",borderRadius:"30px",background:b===e.ar?"var(--color-accent)":"transparent",color:b===e.ar?"#fff":"var(--color-text-main)",fontWeight:b===e.ar?"bold":"normal",transition:"all 0.3s ease",border:b===e.ar?"1px solid var(--color-accent)":"1px solid var(--color-border)"},children:"en"===r&&e.en||e.ar},e.ar))]}),j?(0,i.jsxs)("div",{className:"animate-fade-in",children:[(0,i.jsxs)("div",{className:"flex gap-md items-center mb-md",style:{marginBottom:"0.8rem"},children:[(0,i.jsx)("span",{style:{background:"rgba(0, 91, 171, 0.1)",color:"var(--color-accent)",padding:"0.4rem 1.2rem",borderRadius:"20px",fontSize:"0.95rem",fontWeight:"bold"},children:"en"===r&&(j.category_en||v.find(e=>e.ar===j.category)?.en)||j.category}),(0,i.jsx)("span",{style:{fontSize:"1rem",color:"var(--color-text-muted)"},children:j.date})]}),(0,i.jsx)("h2",{style:{fontSize:"2.2rem",color:"var(--color-primary)",marginBottom:"0.4rem",lineHeight:"1.3"},children:"en"===r&&j.title_en?j.title_en:j.title}),(0,i.jsx)("div",{style:{width:"60px",height:"3px",background:"var(--color-accent)",marginBottom:"1rem",borderRadius:"2px"}}),j.video_url&&x(j.video_url)?(0,i.jsx)("div",{style:{position:"relative",paddingBottom:"56.25%",height:0,overflow:"hidden",maxWidth:"100%",marginBottom:"1.5rem",borderRadius:"12px",boxShadow:"0 4px 15px rgba(0,0,0,0.1)"},children:(0,i.jsx)("iframe",{src:x(j.video_url),style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",border:0},allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0})}):j.image&&(0,i.jsx)("div",{style:{position:"relative",width:"100%",height:"380px",marginBottom:"1.2rem",borderRadius:"12px",overflow:"hidden"},children:(0,i.jsx)(t.default,{src:j.image,alt:j.title,fill:!0,style:{objectFit:"cover"}})}),(0,i.jsx)("div",{className:"article-body-content",style:{fontSize:"1.15rem",lineHeight:"2.1",color:"var(--color-text-main)",opacity:.9,textAlign:"justify"},dangerouslySetInnerHTML:{__html:"en"===r&&j.content_en?j.content_en:j.content}}),(0,i.jsxs)("div",{style:{marginTop:"4rem",paddingTop:"2rem",borderTop:"1px solid var(--color-border)"},children:[(0,i.jsx)("h4",{style:{marginBottom:"1rem",color:"var(--color-primary)"},children:"en"===r?"Have a question about this topic?":"هل لديك استفسار بخصوص هذا الموضوع؟"}),(0,i.jsx)("a",{href:`https://wa.me/201155729429?text=${encodeURIComponent(("en"===r?"Hello, I would like to inquire about the article: ":"مرحباً، أود الاستفسار بخصوص المقال: ")+("en"===r&&j.title_en?j.title_en:j.title))}`,target:"_blank",rel:"noopener noreferrer",className:"btn btn-primary",style:{padding:"0.8rem 2rem"},children:"en"===r?"Contact us via WhatsApp":"تواصل معنا عبر واتساب"})]})]},j.id):(0,i.jsx)("div",{style:{textAlign:"center",padding:"3rem",color:"var(--color-text-muted)"},children:"en"===r?"No articles in this section yet.":"لا توجد مقالات في هذا القسم حالياً. أضف مقالات جديدة لظهورها هنا."})]})]})]})]})}])}]);